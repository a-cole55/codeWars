...
# to get to the pump or not. Function should return true (1 in Prolog, NASM and COBOL) if it is possible and false 
# (0 in Prolog, NASM and COBOL) if not. The input values are always positive.


def zero_fuel(distance_to_pump, mpg, fuel_left):
    #Happy Coding! ;)
    milesLeft= fuel_left * mpg
    if distance_to_pump > milesLeft:
        return False
    else:
        return True
