function fixString(string){
    ...
    let edit = newString.replaceAll("Eek!", "");
    let arr = edit.split("");
    console.log(arr.reverse().join(""));
    return arr.reverse().join("");
  }
//cut at "c" and remove everything up to the c;
